        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-white/80">
              <li><a href="https://thevisionpaints.vercel.app/" className="hover:text-white transition-colors">AI Color Visualization</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-white/80">
              <li><a href="https://www.instagram.com/the_visionpaints?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="__blank" className="hover:text-white transition-colors">Instagram</a></li>
              <li><a href="#why-choose-us" className="hover:text-white transition-colors">Facebook</a></li>
              <li><a href="#contact" className="hover:text-white transition-colors">Linkedin</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-white/80">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>contact@thevisionpaints.in</span>
              </div>
